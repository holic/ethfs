...
class FileReader__factory extends ethers_1.ContractFactory {
    ...
    static linkBytecode(linkLibraryAddresses) {
        ...
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$79896583f45f015cbf360bbefcc2e48d69\\$__", "g"), linkLibraryAddresses["packages/contracts/src/approach2/ContentStoreRegistry.sol:ContentStoreRegistry"]
            .replace(/^0x/, "")
            .toLowerCase());
