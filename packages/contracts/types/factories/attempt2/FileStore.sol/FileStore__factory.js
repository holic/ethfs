...
class FileStore__factory extends ethers_1.ContractFactory {
    ...
    static linkBytecode(linkLibraryAddresses) {
        ...
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$81f1da286928eecde32d52d5f2d871be62\\$__", "g"), linkLibraryAddresses["packages/contracts/src/attempt2/FileReader.sol:FileReader"]
            .replace(/^0x/, "")
            .toLowerCase());
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$f24ba1edace712c6adc99e909abe1b3b79\\$__", "g"), linkLibraryAddresses["packages/contracts/src/attempt2/FileWriter.sol:FileWriter"]
            .replace(/^0x/, "")
            .toLowerCase());
