    ...
    <div className="w-screen min-h-screen pb-[50vh] bg-lime-200 text-lime-800 text-lg flex flex-col">
      ...
      <div className="max-w-screen-md mx-auto flex flex-col gap-12 p-12">
        <div className="flex flex-col gap-2">
          <h1 className="text-5xl text-lime-500 font-black">EthFS Bounties</h1>
          <p>
            <strong>The on-chain community needs your help!</strong> We want the
            files below to exist on chain, but it&apos;s often too cost
